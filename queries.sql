...
UPDATE applicants SET full_name = first_name || ' ' || last_name WHERE first_name='Carol';


UPDATE applicants SET full_name = first_name || ' ' || last_name WHERE email LIKE '%@adipiscingenimmi.edu';
